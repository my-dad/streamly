...
<!-- TODO: verify these task names once the Gradle project is generated -->
...
Single Gradle module `:app`, strict package layering:
io.github.mabrur.streamly
  ...
  ├── player/ # ExoPlayer holder, ShortsPlayerPool, download manager wiring
  └── ui/ # theme, shared composables, one package per feature screen
...
The bundled JSON catalog lives at `app/src/main/assets/catalog.json`. MockEngine reads it
from there. Do not duplicate it into `res/raw/`.
